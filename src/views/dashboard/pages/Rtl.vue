<template>
  <v-container id="rtl" fluid tag="section">
    <v-row class="mb-10">
      <v-col cols="12" md="6">
        <base-material-card
          color="warning"
      ...
      <v-col cols="12" md="6">
        <v-timeline align-top dense>
          ...
          >
            <v-card class="pa-6">
              <v-chip :color="timeline.color" class="text-overline mb-3" small>
                {{ timeline.chip }}
              </v-chip>

              <p class="text-subtitle-1" v-text="timeline.text" />
  ...
  data: () => ({
    ...
    tasks: {
      0: [
        ...
        {
          text:
            "خطوط من الأدب الروسي العظيم؟ أو رسائل البريد الإلكتروني من بوسي؟",
          value: false,
        },
        {
    ...
    timelines: [
      ...
      },
      {
        ...
        actions: ["عمل", "عمل آخر", "شيء آخر هنا"],
      },
    ],
  }),
